  ...
  return (
    <section className="py-12 bg-[#030712] text-white border-t-2 border-t-slate-200">
      ...
      <div className="bg-gray-900 rounded-2xl p-6 shadow-md relative z-10 border-glow text-white 
                transition-transform duration-300 hover:-rotate-4 hover:-rotate-x-4 hover:scale-105">
  <Day1 day1={day1} />
</div>
          ...
          {/* Day 2 */}
            ...
            transition-transform duration-300 hover:-rotate-4 hover:-rotate-y-3 hover:scale-105">
              <Day2 day2={day2} />
            </div>
